...
export PATH=/data/henry7/software/ANTs/Scripts:$PATH
...
export PATH=$PATH:/data/henry6/mindcontrol_ucsf_env/bin
...
# MONSTR
export PATH="/data/henry7/james/MONSTR:$PATH"
export MONSTR_PATH=/data/henry7/james/MONSTR

#meteor
export PATH=$PATH:$HOME/.meteor

# added by Anaconda3 4.3.1 installer
export PATH="/data/henry7/james/anaconda3/bin:$PATH"
source activate james

# Jim6
export PATH=$PATH:/data/henry7/james/Jim6/bin

#Mongo
export PATH=$PATH:/data/henry7/software/mongodb-linux-x86_64-rhel70-3.2.6/bin/
